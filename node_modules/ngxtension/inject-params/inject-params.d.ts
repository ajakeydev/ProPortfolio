...
import { DefaultValueOptions, InjectorOptions, ParseOptions, RequiredOptions } from 'ngxtension/shared';
 ...
 */
export type ParamsOptions<ReadT, WriteT, DefaultValueT> = ParseOptions<ReadT, WriteT> & DefaultValueOptions<DefaultValueT> & InjectorOptions & RequiredOptions;
/**
...
interface InjectParamsBase {
     ...
     */
    <ReadT = string>(key: string, options: ParamsOptions<ReadT, string, ReadT> & {
        required: true;
    }): Signal<ReadT>;
    /**
     * @param {string} key - The name of the parameter to retrieve.
     ...
     */
    <ReadT>(key: string, options: ParamsOptions<ReadT, string, never> & {
     ...
     */
    <ReadT>(key: string, options: ParamsOptions<ReadT, string, ReadT> & {
        parse: (v: string) => ReadT;
        defaultValue: ReadT;
    }): Signal<ReadT>;
    /**
     ...
     */
    <ReadT>(key?: string, options?: ParamsOptions<ReadT, string, ReadT>): Signal<ReadT | null>;
    /**
     ...
     */
    <ReadT>(fn: ParamsTransformFn<ReadT>, options?: InjectorOptions): Signal<ReadT>;
    <T>(keyOrParamsTransform?: string | ((params: Params) => T), options?: ParamsOptions<T, string, T>): Signal<T | Params | string | null>;
}
/**
 ...
 *
 */
export declare const injectParams: InjectParamsFn;
export {};
