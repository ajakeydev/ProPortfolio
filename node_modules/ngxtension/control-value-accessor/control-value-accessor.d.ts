...
export type NgxControlValueAccessorTransform<TModelValue = any, TViewValue = any> = (value: TModelValue) => TViewValue;
export declare const injectCvaTransform: {
    (): NgxControlValueAccessorTransform<any, any>;
    ...
    (injectOptions: import("@angular/core").InjectOptions & {
        injector?: import("@angular/core").Injector;
    }): NgxControlValueAccessorTransform<any, any> | null;
}, provideCvaTransform: (() => import("@angular/core").Provider) & ((value: NgxControlValueAccessorTransform<any, any> | (() => NgxControlValueAccessorTransform<any, any>), isFunctionValue: boolean) => import("@angular/core").Provider);
 ...
 * ```
 */
export declare class NgxControlValueAccessor<T = any> implements ControlValueAccessor {
    /**
     ...
     */
    transform: NgxControlValueAccessorTransform<any, any>;
    /** @ignore */
    ...
    protected readonly notifyNgControlOnValueChanges: import("@angular/core").EffectRef;
    protected readonly notifyNgControlOnDisabledChanges: import("@angular/core").EffectRef;
    /** The value of this. If a control is present, it reflects it's value. */
    set value(value: T);
    get value(): T;
    /** Whether this is disabled. If a control is present, it reflects it's disabled state. */
