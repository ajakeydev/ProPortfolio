...
export declare function effectOnceIf<T = any>(condition: () => T, execution: (valueFromCondition: NonNullable<T>, onCleanup: EffectCleanupRegisterFn) => void, options?: Omit<CreateEffectOptions, 'manualCleanup'>): EffectRef;
