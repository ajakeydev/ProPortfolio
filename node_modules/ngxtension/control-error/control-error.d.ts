...
export declare class NgxControlError {
     ...
     * @see {@link AbstractControl.errors}
     */
    set controlInput(control: AbstractControl | string);
    /**
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<NgxControlError, "[ngxControlError]", never, { "track": { "alias": "ngxControlErrorTrack"; "required": true; }; "controlInput": { "alias": "ngxControlError"; "required": true; }; "errorStateMatcher": { "alias": "ngxControlErrorErrorStateMatcher"; "required": false; }; "parent": { "alias": "ngxControlErrorParent"; "required": false; }; }, {}, never, never, true, never>;
}
