...
import { inject, signal, effect, untracked, booleanAttribute, Directive, Input, Output } from '@angular/core';
...
const identity = (x) => x;
const [injectCvaTransform, provideCvaTransform] = createInjectionToken(() => identity);
...
class NgxControlValueAccessor {
    ...
    constructor() {
         ...
         */
        this.transform = injectCvaTransform();
        /** @ignore */
        this.initialValue = () => {
        ...
        this.notifyNgControlOnValueChanges = effect(() => {
        ...
        this.notifyNgControlOnDisabledChanges = effect(() => {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxControlValueAccessor, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "16.1.0", version: "19.2.9", type: NgxControlValueAccessor, isStandalone: true, inputs: { value: "value", disabled: ["disabled", "disabled", booleanAttribute], compareTo: "compareTo" }, outputs: { valueChange: "valueChange" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxControlValueAccessor, decorators: [{
            type: Directive,
            args: [{
                    standalone: true,
                }]
...
export { NgxControlValueAccessor, injectCvaCompareTo, injectCvaDefaultValue, injectCvaTransform, provideCvaCompareTo, provideCvaCompareToByProp, provideCvaDefaultValue, provideCvaTransform };
