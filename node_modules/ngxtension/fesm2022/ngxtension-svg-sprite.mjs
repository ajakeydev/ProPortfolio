...
import { inject, NgZone, Injectable, makeEnvironmentProviders, provideEnvironmentInitializer, ElementRef, signal, computed, booleanAttribute, Directive, Input } from '@angular/core';
...
class NgxSvgSprites {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxSvgSprites, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxSvgSprites, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxSvgSprites, decorators: [{
            type: Injectable,
...
class NgxSvgSpriteFragment {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxSvgSpriteFragment, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "16.1.0", version: "19.2.9", type: NgxSvgSpriteFragment, isStandalone: true, selector: "svg[fragment]", inputs: { fragment: "fragment", sprite: "sprite", autoViewBoxDisabled: ["autoViewBoxDisabled", "autoViewBoxDisabled", booleanAttribute] }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxSvgSpriteFragment, decorators: [{
            type: Directive,
            args: [{
