...
import { inject, ElementRef, NgZone, PLATFORM_ID, DestroyRef, output, Directive, Input } from '@angular/core';
import { takeUntilDestroyed } from '@angular/core/rxjs-interop';
import { createInjectionToken } from 'ngxtension/create-injection-token';
import { of, ReplaySubject, pipe, debounceTime, takeUntil, Observable, fromEvent, share } from 'rxjs';
...
function injectResize(options = {}) {
    ...
    return createResizeStream(mergedOptions, nativeElement, document, zone, platformId);
}
/**
...
class NgxResize {
    constructor() {
        ...
        this.ngxResize = output();
    }
    ngOnInit() {
        const mergedOptions = { ...this.resizeOptions, ...this.ngxResizeOptions };
        createResizeStream(mergedOptions, this.host.nativeElement, this.document, this.zone, this.platformId)
            .pipe(takeUntilDestroyed(this.destroyRef))
            .subscribe((result) => this.ngxResize.emit(result));
    }
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxResize, deps: [], target: i0.ɵɵFactoryTarget.Directive }); }
    static { this.ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "19.2.9", type: NgxResize, isStandalone: true, selector: "[ngxResize]", inputs: { ngxResizeOptions: "ngxResizeOptions" }, outputs: { ngxResize: "ngxResize" }, ngImport: i0 }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: NgxResize, decorators: [{
            type: Directive,
...
function createResizeStream({ debounce, scroll, offsetSize, box, emitInZone, emitInitialResult, }, nativeElement, document, zone, platformId) {
