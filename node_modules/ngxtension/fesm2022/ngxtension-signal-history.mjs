import { runInInjectionContext, signal, computed } from '@angular/core';
 ...
 */
function signalHistory(source, options) {
...
export { signalHistory };
//# sourceMappingURL=ngxtension-signal-history.mjs.map
