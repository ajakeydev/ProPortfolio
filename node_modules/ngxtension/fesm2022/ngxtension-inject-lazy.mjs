...
import { EnvironmentInjector, DestroyRef, createEnvironmentInjector, Injectable, provideEnvironmentInitializer, inject } from '@angular/core';
...
class InjectLazyImpl {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: InjectLazyImpl, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: InjectLazyImpl, providedIn: 'root' }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.2.9", ngImport: i0, type: InjectLazyImpl, decorators: [{
            type: Injectable,
